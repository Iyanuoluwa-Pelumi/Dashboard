...
export default function SideBar() {
    ...
    return (
        <aside className="relative flex flex-col w-52 justify-around items-center">

            <p className="absolute flex justify-center items-center right-15 top-18 z-30 rounded-full w-6 h-6 text-[rgba(255,255,255,1)] bg-[rgba(220,52,52,1)]">4</p>
